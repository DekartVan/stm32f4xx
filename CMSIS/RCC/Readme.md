...
А это для тех, кто хочет перейти сразу к [примеру]([#3.-Как-настроить-тактирование-с-использованием-внешнего-генератора-**HSE**-и-**PLL**-(*Phase-Locked-Loop*).](https://github.com/DekartVan/stm32f4xx/blob/main/CMSIS/RCC/Readme.md#3-как-настроить-тактирование-с-использованием-внешнего-генератора-hse-и-pll-phase-locked-loop))
