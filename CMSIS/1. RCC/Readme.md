...
А это для тех, кто хочет перейти сразу к [примеру](https://github.com/DekartVan/stm32f4xx/blob/main/CMSIS/1.RCC/Readme.md#3-как-настроить-тактирование-с-использованием-внешнего-генератора-hse-и-pll-phase-locked-loop)
